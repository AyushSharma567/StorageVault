...
const CreateBin = (): JSX.Element => {
  ...
  const API = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJkaWQ6ZXRocjoweDI1OEVhNjc5MmYyOTA1Y2FEMzVmQjA3MjNmOWUxMGI4RDM5MzM3M2MiLCJpc3MiOiJ3ZWIzLXN0b3JhZ2UiLCJpYXQiOjE2OTgyNzAwNzYzNDAsIm5hbWUiOiJ0ZXN0In0.ih2Jx7KGSFozOTo6keElML9h5l1JXmsPk7aRwsNIYCA";
